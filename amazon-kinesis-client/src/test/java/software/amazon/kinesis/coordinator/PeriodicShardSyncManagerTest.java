...
public class PeriodicShardSyncManagerTest {
    ...
    public void setup() {
        ...
        periodicShardSyncManager = new PeriodicShardSyncManager("worker", leaseRefresher, currentStreamConfigMap,
                shardSyncTaskManagerProvider, streamToShardSyncTaskManagerMap, mockScheduledExecutor,
                true, new NullMetricsFactory(), 2 * 60 * 1000, 3,
