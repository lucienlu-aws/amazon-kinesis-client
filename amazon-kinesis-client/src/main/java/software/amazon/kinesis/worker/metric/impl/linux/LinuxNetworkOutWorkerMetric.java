...
public class LinuxNetworkOutWorkerMetric extends LinuxNetworkWorkerMetricBase {
    ...
    public LinuxNetworkOutWorkerMetric(final OperatingRange operatingRange, final String interfaceName,
    ...
    public LinuxNetworkOutWorkerMetric(final OperatingRange operatingRange, final double maxBandwidthInMB) {
        this(operatingRange, DEFAULT_INTERFACE_NAME, DEFAULT_NETWORK_STAT_FILE, maxBandwidthInMB,
                Stopwatch.createUnstarted());
    }

    @VisibleForTesting
    LinuxNetworkOutWorkerMetric(final OperatingRange operatingRange, final String interfaceName, final String statFile,
            final double maxBandwidthInMB, final Stopwatch stopwatch) {
