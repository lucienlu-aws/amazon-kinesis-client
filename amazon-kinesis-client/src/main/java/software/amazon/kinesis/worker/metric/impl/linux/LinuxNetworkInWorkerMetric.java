...
public class LinuxNetworkInWorkerMetric extends LinuxNetworkWorkerMetricBase {
    ...
    public LinuxNetworkInWorkerMetric(final OperatingRange operatingRange, final String interfaceName,
    ...
    @VisibleForTesting
    LinuxNetworkInWorkerMetric(final OperatingRange operatingRange, final String interfaceName, final String statFile,
